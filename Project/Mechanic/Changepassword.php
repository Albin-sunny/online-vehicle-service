...
$dbPassword = $data['mechanic_password'];
...
if (isset($_POST['txt_btn'])) {
    ...
    if ($dbPassword == $Oldpassword) {
        if ($NewPassword == $Repassword) {
            $upqury = "UPDATE tbl_mechanic SET mechanic_password='" . $NewPassword . "' WHERE mechanic_id='" . $_SESSION['mechanic'] . "'";
            ...
            <form id="form1" name="form1" method="post" action="">
                <table>
                    <tr>
                        ...
                        <td><input type="text" name="txt_oldPassword" id="txt_oldPassword" placeholder="Enter Old Password" required /></td>
                    </tr>
                    <tr>
                        <td><b>New Password</b></td>
                        <td><input type="text" name="txt_Newpassword" id="txt_Newpassword" placeholder="Enter New Password" required /></td>
                    </tr>
                    <tr>
                        <td><b>Re-Type Password</b></td>
                        <td><input type="text" name="txt_RePassword" id="txt_RePassword" placeholder="Re-type New Password" required /></td>
                    </tr>
                    <tr>
