...
<footer class="footer">
            <div class="card">
                <div class="card-body">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="text-muted text-center text-sm-left d-block d-sm-inline-block"> boldCopyright © 2020 <a href="https://www.bootstrapdash.com/" class="text-muted" target="_blank">Bootstrapdash</a>. All rights reserved.</span>
  ...
  <script src="../Assets/Templates/Admin/js/settings.js"></script>
  <script src="../Assets/Templates/Admin/js/todolist.js"></script>
  <!-- endinject -->
