...
<form id="form1" name="form1" method="post" action="">
  <table width="200" border="1">
    ...
    <?php 
	 ...
	 $sel="select * from  tbl_assignwork a inner join  tbl_mechanic m on a.mechanic_id=m.mechanic_id inner join  tbl_rereques r  on a.request_id=r.request_id where a.request_id='".$_GET['mid']."'";
	$res=$conn->query($sel);
